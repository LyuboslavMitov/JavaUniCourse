...
public class GameEngineTest  {
	...
	public void testHealing() {
		Hero h=new Hero("pencho", 100, 100);
		h.takeDamage(90);
		h.takeHealing(100);
		h.learn(new Spell("FIREBALL", 1000, 70));
		h.attack();
		assertEquals(h.getMana(), 30);
		h.takeMana(150);
		assertEquals(h.getHealth(), 100);
		assertEquals(h.getMana(), 100);
		h.learn(new Spell("firee", 1001, 70));
		
		assertEquals("firee", h.getSpell().getName());
	}
